...
export default function KutubPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <Breadcrumbs items={[{ label: t('navKutub') }]} />
      ...
      <div className="pb-6 border-b border-stone-200 dark:border-stone-800 mb-8">
        <span className="text-xs font-bold text-emerald-800 dark:text-emerald-400 tracking-wider uppercase">
          Classical Texts &amp; Treatises
        </span>
        <h1 className="font-serif font-bold text-3xl sm:text-4xl text-stone-900 dark:text-stone-100 mt-1">
          {language === 'ar' ? 'الكتب والمتون والمذكرات العلمية' : 'Books, Treatises & Texts'}
        </h1>
        <p className="text-xs sm:text-sm text-stone-600 dark:text-stone-400 mt-2 max-w-2xl leading-relaxed">
          {language === 'ar'
            ? 'مكتبة المتون التراثية والكتب المقررة المشروحة في دروس الشيخ محمد زين، متوفرة للقراءة والتحميل بصيغة PDF مع فهرس تفصيلي.'
            : 'Curated collection of classical texts, annotated treatises, and course notes explained by Shaykh Muhammad Zain, complete with chapter navigation and downloadable PDFs.'}
        </p>
      </div>
